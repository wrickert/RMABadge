...
extern volatile uint8_t Mode_NO;
...
uint8_t RGB_PWM_IS31FL3741[512]=
{
...
void IS31FL3741_PWM_Write(uint8_t iColor, uint8_t iX, uint8_t iY, uint8_t idata)
{
	switch(iColor)
	{
...
void IS31FL3741_LED_X(uint8_t iColor,uint8_t iX1,uint8_t iY1,uint8_t iY2,uint8_t iY3,uint8_t iY4,uint8_t iY5,uint8_t iY6,uint8_t iY7,uint8_t iY8,uint8_t iY9,uint8_t iY10,uint8_t iY11,uint8_t iY12,uint8_t iY13)
{
...
void IS31FL3741_LED_X_Samedata(uint8_t iColor,uint8_t iX1,uint8_t iY1)
{
	IS31FL3741_PWM_Write(iColor,iX1,1,iY1);
...
void IS31FL3741_LED_Y(uint8_t iColor,uint8_t iY1,uint8_t iX1,uint8_t iX2,uint8_t iX3,uint8_t iX4,uint8_t iX5,uint8_t iX6,uint8_t iX7,uint8_t iX8,uint8_t iX9)
{
...
void IS31FL3741_LED_Y_Samedata(uint8_t iColor,uint8_t iY1,uint8_t iX1)
{
	IS31FL3741_PWM_Write(iColor,1,iY1,iX1);
...
void IS31FL3741_B_LED_SCAL_PWM(uint8_t ipage, uint8_t idata)
{
	uint8_t i;
	if (ipage == SCAL)
	{
...
void IS31FL3741_G_LED_SCAL_PWM(uint8_t ipage, uint8_t idata)
{
	uint8_t i;
	if (ipage == SCAL)
	{
...
void IS31FL3741_R_LED_SCAL_PWM(uint8_t ipage, uint8_t idata)
{
	uint8_t i;
	if (ipage == SCAL)
	{
...
uint8_t IS31FL3741_Mode_1(void)//Rainbow wave
{
	uint8_t com1;
	uint8_t x=128;
	uint8_t y=64;
...
uint8_t IS31FL3741_Mode_2(void)//Rainbow wave
{
	uint8_t i;
	uint8_t p_temp;
	uint8_t pb1,pr1,pg1;
...
uint8_t IS31FL3741_Mode_3(void)//Rain
{
	uint8_t iCnt = 0;
	uint8_t x,y,k;
...
uint8_t IS31FL3741_Mode_4(void)//Visor
{
	uint8_t iCnt = 0;
	uint8_t x,y,k;
