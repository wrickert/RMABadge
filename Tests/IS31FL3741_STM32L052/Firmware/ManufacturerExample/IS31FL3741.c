...
void IS31FL3741_PWM_Write(u8 iColor, u8 iX, u8 iY, u8 idata)
{
	switch(iColor)
	{
...
void IS31FL3741_LED_X(u8 iColor,u8 iX1,u8 iY1,u8 iY2,u8 iY3,u8 iY4,u8 iY5,u8 iY6,u8 iY7,u8 iY8,u8 iY9,u8 iY10,u8 iY11,u8 iY12,u8 iY13)
{
...
void IS31FL3741_LED_X_Samedata(u8 iColor,u8 iX1,u8 iY1)
{
	IS31FL3741_PWM_Write(iColor,iX1,1,iY1);
...
void IS31FL3741_LED_Y(u8 iColor,u8 iY1,u8 iX1,u8 iX2,u8 iX3,u8 iX4,u8 iX5,u8 iX6,u8 iX7,u8 iX8,u8 iX9)
{
...
void IS31FL3741_LED_Y_Samedata(u8 iColor,u8 iY1,u8 iX1)
{
	IS31FL3741_PWM_Write(iColor,1,iY1,iX1);
...
void IS31FL3741_B_LED_SCAL_PWM(u8 ipage, u8 idata)
{
	u8 i;
	if (ipage == SCAL)
	{
...
void IS31FL3741_G_LED_SCAL_PWM(u8 ipage, u8 idata)
{
	u8 i;
	if (ipage == SCAL)
	{
...
void IS31FL3741_R_LED_SCAL_PWM(u8 ipage, u8 idata)
{
	u8 i;
	if (ipage == SCAL)
	{
...
u8 IS31FL3741_Mode_1(void)//Rainbow wave
{
	u8 com1;
	u8 x=128;
	u8 y=64;
...
u8 IS31FL3741_Mode_2(void)//Rainbow wave
{
	u8 i;
	u8 p_temp;
	u8 pb1,pr1,pg1;
...
u8 IS31FL3741_Mode_3(void)//Rain
{
	u8 iCnt = 0;
	u8 x,y,k;
	u8 irand = rand()%9;
...
u8 IS31FL3741_Mode_4(void)//Visor
{
	u8 iCnt = 0;
	u8 x,y,k;
